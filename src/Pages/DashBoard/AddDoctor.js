...
const AddDoctor = () => {
    ...
    const imageStorageKey = '9fa38d64a781e8e9aec5482054a5837d';
    /**
     * 3 ways to store image
     * 1. Third party storage // Free open public storage Practice project
    ...
    const onSubmit = async data => {
        ...
        fetch(url, {
            ...
            .then(result => {
                ...
                console.log('image bd result', result);
            })
